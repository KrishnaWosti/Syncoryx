...
export function Hero() {
  return (
    <section className="container relative pt-12 sm:pt-16 lg:pt-20">
      <div className="absolute -top-10 left-1/2 -translate-x-1/2 h-[520px] w-[520px] rounded-full blur-3xl opacity-30 bg-[radial-gradient(circle_at_30%_20%,rgba(124,58,237,0.85),transparent_60%),radial-gradient(circle_at_70%_60%,rgba(6,182,212,0.7),transparent_58%),radial-gradient(circle_at_40%_80%,rgba(251,113,133,0.6),transparent_60%)]" />
      <div className="absolute inset-x-0 top-10 h-80 opacity-80">
        <div className="noise" />
      </div>

      <div className="relative glass p-6 sm:p-8 lg:p-10 overflow-hidden">
        ...
        >
          ...
          <h1 className="mt-4 text-4xl sm:text-5xl lg:text-6xl font-semibold tracking-tight text-white">
            Clean data.
            <span className="text-transparent bg-clip-text bg-[linear-gradient(90deg,#a3e635,#06b6d4,#7c3aed,#fb7185)]">
              {" "}
              Sharp flows.
            </span>
